...
NormalizedRadonCDT.generator_temp(1, 1, 1, [2, 4, 7])

# ╔═╡ 4d9195e5-5e6e-4932-8b3b-992403cef7b2
NormalizedRadonCDT.view_temp(1, 1, 1, [2, 4, 7])

# ╔═╡ 21c0724b-ed8c-468f-a45e-6453f6b8cc9f
data_size = 128; samp_size = 100; random_seed = 42; choice_of_temp_images = [2, 5, 8];
