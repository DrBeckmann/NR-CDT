...
begin
	circle = NormalizedRadonCDT.TestImages.Circle(1.0)
...
begin
	triangle = NormalizedRadonCDT.TestImages.Polygon(3, π/2, 1.0)
...
begin
	square = NormalizedRadonCDT.TestImages.Polygon(4, π/4, 1.0)
...
begin
	star = NormalizedRadonCDT.TestImages.Star(7, 0, 1.0)
...
begin
	orbandcross = NormalizedRadonCDT.TestImages.OrbAndCross(square, star, 1.0)
...
begin
	shield = NormalizedRadonCDT.TestImages.Shield(circle, 1.0)
