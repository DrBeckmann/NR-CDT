...
# ╠═╡ disabled = true
#=╠═╡
@time NormalizedRadonCDT.classify_mnist_NRCDT(number_mnist_1, 10, 42, 32, 32, 2, 3.3, 0)
  ╠═╡ =#

# ╔═╡ ad34a937-9100-49f7-9a72-e61a8786b24e
# ╠═╡ disabled = true
#=╠═╡
@time NormalizedRadonCDT.classify_mnist_NRCDT(number_mnist_1, 20, 42, 32, 32, 2, 3.3, 0)
  ╠═╡ =#

# ╔═╡ 016181b0-663a-4678-96e3-ebb1f8c6af69
# ╠═╡ disabled = true
#=╠═╡
@time NormalizedRadonCDT.classify_mnist_NRCDT(number_mnist_1, 50, 42, 32, 32, 2, 3.3, 0)
  ╠═╡ =#
...
@time NormalizedRadonCDT.classify_mnist_NRCDT(number_mnist_1, 10, 42, 32, 32, 2, 2, 0)

# ╔═╡ daa8eb1c-e6e3-4b51-a0e0-61a9d06b5b04
@time NormalizedRadonCDT.classify_mnist_NRCDT(number_mnist_1, 20, 42, 32, 32, 2, 2, 0)

# ╔═╡ 580aded5-3db6-4b7b-bd43-3f1f01d2efd7
@time NormalizedRadonCDT.classify_mnist_NRCDT(number_mnist_1, 50, 42, 32, 32, 2, 2, 0)

# ╔═╡ ed1684ac-d948-4475-b513-abd3f208bd1f
@time NormalizedRadonCDT.classify_mnist_NRCDT(number_mnist_1, 100, 42, 32, 32, 2, 2, 0)

# ╔═╡ cf37387c-1100-4fda-a09c-9831be970916
@time NormalizedRadonCDT.classify_mnist_NRCDT(number_mnist_1, 250, 42, 32, 32, 2, 2, 0)

# ╔═╡ 9749ee49-b4f9-484d-b261-3d1ea34f0f7b
@time NormalizedRadonCDT.classify_mnist_NRCDT(number_mnist_1, 500, 42, 32, 32, 2, 2, 0)

# ╔═╡ d1e83edb-ed63-4ee6-ae00-099657ecb343
@time NormalizedRadonCDT.classify_mnist_NRCDT(number_mnist_1, 1000, 42, 32, 32, 2, 2, 0)
