...
for angle in 1:3
	for num in 0:19
		for r in 1:20
			E = ElasticNoise(
			    amplitude_x=(0.0, Float64(r)),
			    amplitude_y=(0.0, Float64(r)),
			    frequency_x=(0.0, 2.0),
			    frequency_y=(0.0, 2.0),
			)
			S = SaltNoise(
			...
			jldsave("acc_all_NRCDTs_test_2.jld2"; CC)
		end
	end
end
