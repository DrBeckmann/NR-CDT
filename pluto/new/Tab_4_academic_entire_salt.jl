...
# ╔═╡ b026824c-7212-4c18-a05a-8c090143ca2e
# ╠═╡ disabled = true
#=╠═╡
...
# ╔═╡ be4af3a9-1ac2-4265-a6d2-8229aa847c20
# ╠═╡ disabled = true
#=╠═╡
CC = accuracy_k_nearest_part_neighbour(20, 5, 100, 12, aqClass, Labels, "inf", K=1, ret=1);
  ╠═╡ =#

# ╔═╡ eaee8674-b31c-4e76-8302-aacdd005c082
# ╠═╡ disabled = true
#=╠═╡
...
# ╠═╡ disabled = true
#=╠═╡
savefig(hh, "academic_entire_salt_1NN_5_mean_inf.pdf")
  ╠═╡ =#

# ╔═╡ 1e5d712d-8c3e-450e-a874-c7ba54ef2460
# ╠═╡ disabled = true
#=╠═╡
savefig(hhp, "academic_entire_salt_1NN_5_mean_inf_1p.pdf")
  ╠═╡ =#
