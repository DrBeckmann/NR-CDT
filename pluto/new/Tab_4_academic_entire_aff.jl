...
# ╠═╡ disabled = true
#=╠═╡
CC = accuracy_k_nearest_part_neighbour(20, 10, 100, 12, mqClass, Labels, "euclidean", K=1, ret=1);
  ╠═╡ =#
...
# ╠═╡ disabled = true
#=╠═╡
savefig(hhp, "academic_entire_1NN_10_max_eucl_1p.pdf")
  ╠═╡ =#

# ╔═╡ b672f1d2-bf4c-41e2-ba16-c7ee420183eb
# ╠═╡ disabled = true
#=╠═╡
savefig(hh, "academic_entire_1NN_10_max_eucl.pdf")
  ╠═╡ =#
