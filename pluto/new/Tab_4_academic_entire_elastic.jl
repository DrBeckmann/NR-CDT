...
# ╠═╡ disabled = true
#=╠═╡
CC = accuracy_k_nearest_part_neighbour(20, 10, 100, 12, aqClass, Labels, "euclidean", K=1, ret=1);
  ╠═╡ =#
...
# ╔═╡ 08dd6714-4625-4c1a-8574-2c29dbfd51df
# ╠═╡ disabled = true
#=╠═╡
...
# ╠═╡ disabled = true
#=╠═╡
savefig(hh, "academic_entire_elastic_1NN_10_mean_eucl.pdf")
  ╠═╡ =#

# ╔═╡ eaf4ea81-95ef-4d69-816a-8a8d62006583
# ╠═╡ disabled = true
#=╠═╡
savefig(hhp, "academic_entire_elastic_1NN_10_mean_eucl_1p.pdf")
  ╠═╡ =#
