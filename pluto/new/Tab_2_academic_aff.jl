...
S = DataTransformations.SaltNoise((5,10), (4/128, 4/128))
...
qTemp = RCDT.(J); mqTemp = max_normalization.(qTemp); aqTemp = mean_normalization.(qTemp);

# ╔═╡ e1d7ede5-1b44-4186-9b9e-21e6ddd29dda
mp = plot_quantiles(mqTemp, Label, mqClass, Labels)

# ╔═╡ 7c4d2587-a023-43aa-baac-63102bd73f68
# ╠═╡ disabled = true
#=╠═╡
savefig(mp, "max_quantiles_aff.pdf")
  ╠═╡ =#

# ╔═╡ dd239355-c9d4-4556-8134-9ab747f83b59
ap = plot_quantiles(aqTemp, Label, aqClass, Labels)

# ╔═╡ 90e51c99-820a-4fc7-a7b0-be48523a8135
# ╠═╡ disabled = true
#=╠═╡
savefig(ap, "mean_quantiles_aff.pdf")
  ╠═╡ =#
