...
R = RadonTransform(floor(Int,sqrt(2)*256),365,0.0)
...
# ╔═╡ 5ed28cfd-baa6-4bd0-808b-bbf8051461ac
tTClass = [transpose(Array{Float64}(TClass[i])) for i in 1:length(TClass)];

# ╔═╡ 5643d1b8-3565-4125-bfcd-545941513f0b
NormalizedRadonCDT.classify_flatten_svm(tTClass, Labels)
