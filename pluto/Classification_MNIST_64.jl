...
@time NormalizedRadonCDT.classify_mnist_NRCDT(number_mnist_1, 10, 42, 64, 64, 2, 2, 0)

# ╔═╡ daa8eb1c-e6e3-4b51-a0e0-61a9d06b5b04
@time NormalizedRadonCDT.classify_mnist_NRCDT(number_mnist_1, 20, 42, 64, 64, 2, 2, 0)

# ╔═╡ 580aded5-3db6-4b7b-bd43-3f1f01d2efd7
@time NormalizedRadonCDT.classify_mnist_NRCDT(number_mnist_1, 50, 42, 64, 64, 2, 2, 0)

# ╔═╡ b498df5b-6217-49b2-8484-b8661277b291
@time NormalizedRadonCDT.classify_mnist_NRCDT(number_mnist_1, 100, 42, 64, 64, 2, 2, 0)

# ╔═╡ ed1684ac-d948-4475-b513-abd3f208bd1f
@time NormalizedRadonCDT.classify_mnist_NRCDT(number_mnist_1, 250, 42, 64, 64, 2, 2, 0)

# ╔═╡ cf37387c-1100-4fda-a09c-9831be970916
@time NormalizedRadonCDT.classify_mnist_NRCDT(number_mnist_1, 500, 42, 64, 64, 2, 2, 0)

# ╔═╡ f09149bd-6e92-4108-b3c8-cd5fcec202b0
@time NormalizedRadonCDT.classify_mnist_NRCDT(number_mnist_1, 1000, 42, 64, 64, 2, 2, 0)
